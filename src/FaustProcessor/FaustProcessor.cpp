...
Compilation options: -a /Users/mwicat/opt/Faust-2.37.3/share/faust/teensy/teensy.cpp -lang cpp -es 1 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/mwicat/opt/Faust-2.37.3/share/faust/teensy/teensy.cpp -lang cpp -es 1 -single -ftz 0");
		m->declare("delays.lib/name", "Faust Delay Library");
		m->declare("delays.lib/version", "0.1");
		m->declare("filename", "FaustProcessor.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst1 = std::tan((314.159271f / fConst0));
		fConst2 = (1.0f / fConst1);
		float fConst3 = (fConst2 + 1.0f);
		fConst4 = (0.0f - (1.0f / (fConst1 * fConst3)));
		float fConst5 = std::tan((12566.3711f / fConst0));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("FaustProcessor");
		ui_interface->addVerticalSlider("Freq", &fVslider0, FAUSTFLOAT(200.0f), FAUSTFLOAT(200.0f), FAUSTFLOAT(1000.0f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			float fTemp0 = (fSlow1 + (fRec10[1] + -1.0f));
			int iTemp1 = (fTemp0 < 0.0f);
			float fTemp2 = (fSlow1 + fRec10[1]);
			fRec10[0] = (iTemp1 ? fTemp2 : fTemp0);
			float fThen1 = (fSlow1 + (fRec10[1] + (fSlow2 * fTemp0)));
			float fRec11 = (iTemp1 ? fTemp2 : fThen1);
			float fTemp3 = (2.0f * fRec11);
			float fTemp4 = ((fTemp3 + (0.74000001f * ((0.319999993f * fRec1[((IOTA - 2997) & 4095)]) + (0.680000007f * fRec1[((IOTA - 2998) & 4095)])))) + -1.0f);
			fVec0[0] = fTemp4;
			fRec9[0] = ((fConst8 * fVec0[1]) - (fConst10 * ((fConst11 * fRec9[1]) - (fConst6 * fTemp4))));
			fRec12[0] = (0.0f - (fConst10 * ((fConst11 * fRec12[1]) - (fTemp4 + fVec0[1]))));
			float fTemp5 = (fRec9[0] + fRec12[0]);
			fVec1[0] = fTemp5;
			fRec8[0] = ((fConst4 * fVec1[1]) - (fConst12 * ((fConst13 * fRec8[1]) - (fConst2 * fTemp5))));
			fRec13[0] = (0.0f - (fConst12 * ((fConst13 * fRec13[1]) - (fTemp5 + fVec1[1]))));
			float fTemp6 = ((fRec8[0] + fRec13[0]) - (0.540000021f * fRec6[1]));
			fVec2[(IOTA & 1023)] = fTemp6;
			fRec6[0] = ((0.216000006f * fVec2[((IOTA - 1011) & 1023)]) + (0.783999979f * fVec2[((IOTA - 1012) & 1023)]));
			float fRec7 = (0.540000021f * fTemp6);
			float fTemp7 = ((fRec7 + fRec6[1]) - (0.540000021f * fRec4[1]));
			fVec3[(IOTA & 2047)] = fTemp7;
			fRec4[0] = ((0.35800001f * fVec3[((IOTA - 1606) & 2047)]) + (0.64200002f * fVec3[((IOTA - 1607) & 2047)]));
			float fRec5 = (0.540000021f * fTemp7);
			float fTemp8 = ((fRec5 + fRec4[1]) - (0.540000021f * fRec2[1]));
			fVec4[(IOTA & 2047)] = fTemp8;
			fRec2[0] = fVec4[((IOTA - 1999) & 2047)];
			float fRec3 = (0.540000021f * fTemp8);
			fRec0[(IOTA & 4095)] = (fRec3 + fRec2[1]);
			float fTemp9 = ((fTemp3 + (0.74000001f * ((0.319999993f * fRec0[((IOTA - 2997) & 4095)]) + (0.680000007f * fRec0[((IOTA - 2998) & 4095)])))) + -1.0f);
			fVec5[0] = fTemp9;
			fRec21[0] = ((fConst8 * fVec5[1]) - (fConst10 * ((fConst11 * fRec21[1]) - (fConst6 * fTemp9))));
			fRec22[0] = (0.0f - (fConst10 * ((fConst11 * fRec22[1]) - (fTemp9 + fVec5[1]))));
			float fTemp10 = (fRec21[0] + fRec22[0]);
			fVec6[0] = fTemp10;
			fRec20[0] = ((fConst4 * fVec6[1]) - (fConst12 * ((fConst13 * fRec20[1]) - (fConst2 * fTemp10))));
			fRec23[0] = (0.0f - (fConst12 * ((fConst13 * fRec23[1]) - (fTemp10 + fVec6[1]))));
			float fTemp11 = ((fRec20[0] + fRec23[0]) - (0.540000021f * fRec18[1]));
			fVec7[(IOTA & 1023)] = fTemp11;
			fRec18[0] = ((0.216000006f * fVec7[((IOTA - 1011) & 1023)]) + (0.783999979f * fVec7[((IOTA - 1012) & 1023)]));
			float fRec19 = (0.540000021f * fTemp11);
			float fTemp12 = ((fRec19 + fRec18[1]) - (0.540000021f * fRec16[1]));
			fVec8[(IOTA & 2047)] = fTemp12;
			fRec16[0] = ((0.35800001f * fVec8[((IOTA - 1606) & 2047)]) + (0.64200002f * fVec8[((IOTA - 1607) & 2047)]));
			float fRec17 = (0.540000021f * fTemp12);
			float fTemp13 = ((fRec17 + fRec16[1]) - (0.540000021f * fRec14[1]));
			fVec9[(IOTA & 2047)] = fTemp13;
			fRec14[0] = fVec9[((IOTA - 1999) & 2047)];
			float fRec15 = (0.540000021f * fTemp13);
			fRec1[(IOTA & 4095)] = (fRec15 + fRec14[1]);
			output0[i0] = FAUSTFLOAT(fRec0[((IOTA - 0) & 4095)]);
			output1[i0] = FAUSTFLOAT(fRec1[((IOTA - 0) & 4095)]);
			fRec10[1] = fRec10[0];
			fVec0[1] = fVec0[0];
			fRec9[1] = fRec9[0];
			fRec12[1] = fRec12[0];
	...
	#define FAUST_FILE_NAME "FaustProcessor.dsp"
	...
	FAUST_ADDVERTICALSLIDER("Freq", fVslider0, 200.0f, 200.0f, 1000.0f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, Freq, "Freq", fVslider0, 200.0f, 200.0f, 1000.0f, 1.0f) \
...
FaustProcessor::FaustProcessor() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void FaustProcessor::updateImp(void)
{
#if MIDICTRL
...
void FaustProcessor::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void FaustProcessor::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float FaustProcessor::getParamValue(const std::string& path)
{
